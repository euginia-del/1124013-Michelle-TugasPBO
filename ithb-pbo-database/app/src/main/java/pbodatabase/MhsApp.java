...
public class MhsApp {
    ...
    private void tambahKaryawan() {
        ...
        if (tipe.equals("1")) {
            ...
            honorPerSKS = Double.parseDouble(scanner.nextLine());
            System.out.print("Total SKS: ");
            totalSKS = Integer.parseInt(scanner.nextLine());
    ...
    private void hapusKaryawan() {
        tampilkanKaryawan();
        if (karyawanCtrl.getAll().isEmpty()) {
            return;
        }
    ...
    private void editMahasiswa() {
        tampilkanMahasiswa();
        if (mahasiswaCtrl.getAll().isEmpty()) {
            return;
        }
    ...
    private void editNilaiEnrollment() {
        tampilkanEnrollment();
        if (enrollmentCtrl.getAll().isEmpty()) {
            return;
        }
